// https://github.com/dotnet/aspnetcore/blob/master/src/Components/Components/src/Routing/RouteTableFactory.cs
...
namespace BlazorTenant
{
    ...
    internal static class MultiTenantRouteTableFactory
    {
        ...
        internal static MultiTenantRouteTable Create(IEnumerable<Type> componentTypes)
        {
